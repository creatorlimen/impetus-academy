  ...
  return (
    <section className="px-6 py-24">
      <div className="dark-panel mx-auto max-w-4xl rounded-[2.75rem] p-8 text-white sm:p-10">
        <p className="font-mono text-[0.68rem] uppercase tracking-[0.22em] text-white/48">Page not found</p>
        <h1 className="mt-5 text-4xl font-semibold tracking-[-0.05em] sm:text-5xl">Let’s get you back to the right school journey.</h1>
