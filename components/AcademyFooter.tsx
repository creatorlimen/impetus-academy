...
export default function AcademyFooter() {
  ...
  return (
    <footer className="relative mt-24 overflow-hidden rounded-t-[3.5rem] bg-[#FFF5E9] text-primary-950">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(232,117,18,0.18),transparent_30%),linear-gradient(180deg,rgba(101,75,199,0.1),transparent_40%)]" />
      <div className="relative mx-auto max-w-7xl px-6 py-16 md:py-20">
        <div className="flex flex-col gap-10 border-b border-white/10 pb-10 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-2xl">
            <p className="font-label text-[0.68rem] uppercase tracking-[0.14em] text-accent-700">{settings.tagline}</p>
          ...
          <div className="dark-panel rounded-[2rem] p-6 sm:p-7 lg:max-w-sm">
            <p className="font-label text-[0.65rem] uppercase tracking-[0.14em] text-accent-700">Admissions Contact</p>
        ...
        <div className="grid grid-cols-1 gap-12 pt-10 md:grid-cols-[1.1fr_0.8fr_0.8fr_0.8fr]">
          <div>
            <div className="inline-flex rounded-[1.75rem] bg-white p-4 shadow-[0_18px_48px_rgba(23,16,68,0.16)]">
              <Image
          ...
          <div>
            <h3 className="font-label text-[0.68rem] font-medium uppercase tracking-[0.14em] text-accent-700">Primary School</h3>
            <ul className="mt-5 space-y-3 text-sm text-primary-950/72">
              {primaryNavigation.map((link) => (
                <li key={link.href}><Link href={link.href} className="hover:text-accent-700">{link.label}</Link></li>
              ))}
            </ul>
          </div>

          <div>
            <h3 className="font-label text-[0.68rem] font-medium uppercase tracking-[0.14em] text-accent-700">Secondary School</h3>
            <ul className="mt-5 space-y-3 text-sm text-primary-950/72">
          ...
          <div>
            <h3 className="font-label text-[0.68rem] font-medium uppercase tracking-[0.14em] text-accent-700">General</h3>
            <ul className="mt-5 space-y-3 text-sm text-primary-950/72">
        ...
        <div className="mt-12 flex flex-col gap-4 border-t border-white/10 pt-8 text-sm text-primary-950/42 md:flex-row md:items-center md:justify-between">
          <p className="text-sm text-primary-950/52">Primary and Secondary education in Ijaye, Lagos.</p>
